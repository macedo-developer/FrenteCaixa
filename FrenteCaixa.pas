...
uses uVendas, uDesconto, uRelatorioProdutos;
...
begin
  ...
  DtModule.Connection.Params.Values['database'] :=
    ArquivoINI.ReadString('FRENTECAIXA', 'database', '');
  DtModule.Connection.Params.Values['user_name'] :=
    ArquivoINI.ReadString('FRENTECAIXA', 'user_name', '');
  DtModule.Connection.Params.Values['password'] :=
    ArquivoINI.ReadString('FRENTECAIXA', 'password', '');
  DtModule.Connection.Params.Values['server'] :=
    ArquivoINI.ReadString('FRENTECAIXA', 'server', '');
  DtModule.Connection.Params.Values['port'] :=
    ArquivoINI.ReadString('FRENTECAIXA', 'port', '');;
...
procedure TfFrenteCaixa.btnRelProdutosClick(Sender: TObject);
begin
  fRelatorioProdutos.ShowModal;
end;
